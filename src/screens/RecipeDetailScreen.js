    ...
    >
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionTitle} testID="ingredientsTitle">
            Ingredients
          </Text>
          <View style={styles.ingredientsList}>
            {recipe.ingredients.map(({ ingredientName, measure }, index) => (
              <View
                key={index}
                style={styles.ingredientItem}
                testID={`ingredientItem-${index}`}
              >
        ...
        <View style={styles.sectionContainer} testID="sectionContainer">
          <Text style={styles.sectionTitle} testID="instructionsTitle">
            Instructions
          </Text>
